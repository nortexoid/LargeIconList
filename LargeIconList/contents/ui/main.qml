    ...
    **/
    ...
    PlasmaCore.Dialog {
        ...
        mainItem: Item {
            ...
            property int optimalWidth: textMetrics.width + PlasmaCore.Units.iconSizes.medium + 2 * PlasmaCore.Units.mediumSpacing + hoverItem.margins.right + hoverItem.margins.left
